...
export default function PMDashboardPage() {
  ...
  // 1. Add state to track if the active page has unsaved progress
  ...
  const handleNavigate = (pageName) => {
    if (isPageDirty && pageName !== activePage) {
      setNavigationTarget(pageName);
  ...
  const handleConfirmNavigation = () => {
    ...
    setActivePage(navigationTarget);
  ...
  const navItems = [
    { name: "Assign", icon: SendHorizonal },
